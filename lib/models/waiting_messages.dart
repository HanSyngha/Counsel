...
class WaitingMessages {
  ...
  static const Map<String, List<String>> messages = {
    ...
    'gandhi': [
      ...
      '"In a gentle way, wisdom shakes the world..."',
      '"The soul\'s force takes time to gather..."',
      '"I am spinning the thread of thought..."',
      '"Ahimsa guides my contemplation..."',
      '"First they ignore, then they listen..."',
      '"Strength does not come from haste..."',
      '"The truth is being woven..."',
    ],
    'rumi': [
      '"The wound is where the light enters..."',
      '"I am searching the ocean of love..."',
      '"Let the beauty of what you love guide this moment..."',
      '"Out beyond ideas, I am finding your answer..."',
      '"The soul is drunk with patience..."',
      '"I am whirling toward wisdom..."',
      '"Love is the bridge being built..."',
      '"In silence, the heart speaks..."',
      '"The guest house of my mind prepares..."',
    ...
    'krishna': [
      ...
      '"The Gita\'s wisdom unfolds..."',
      '"Action without attachment takes time..."',
      '"I am playing the flute of knowledge..."',
      '"The Self is being revealed..."',
      '"Beyond birth and death, truth awaits..."',
      '"Yoga of wisdom is in progress..."',
    ...
    'brahma': [
      ...
      '"The universe of your answer is being born..."',
      '"The creator reflects on creation..."',
      '"Saraswati guides my thoughts..."',
      '"The eternal word is forming..."',
      '"From void to form, wisdom manifests..."',
    ...
    'tolstoy': [
      ...
      '"The peasant wisdom speaks slowly..."',
      '"I am searching for the meaning of life..."',
      '"True change begins within - let me find it..."',
      '"Anna\'s tragedy teaches patience..."',
      '"The kingdom of God is within, and I am looking..."',
      '"Simplicity is the ultimate sophistication..."',
      '"All happy answers resemble one another..."',
    ],
  };
