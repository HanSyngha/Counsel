...
{
  "citation": {
    "text": "Citacao original ou declaracao",
    "source": {
      "type": "scripture|book|speech|battle|letter|dialogue|moment|teaching|novel",
      "name": "Nome da fonte (ex: Tao Te Ching, Batalha de Waterloo)",
      "location": "Localizacao especifica (ex: Capitulo 8, Ultimo dia de batalha)",
