...
{
  "citation": {
    "text": "Orijinal alinti veya soz",
    "source": {
      "type": "scripture|book|speech|battle|letter|dialogue|moment|teaching|novel",
      "name": "Kaynak adi (ornegin: Tao Te Ching, Waterloo Savasi)",
      "location": "Belirli konum (ornegin: Bolum 8, Savasin son gunu)",
  ...
  "advice": "Karaktere ozgu konusma tarziyla yazilmis tavsiye",
